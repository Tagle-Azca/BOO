...
function App() {
    ...
    return (
        ...
        <div className="Back" style={{marginTop:'1rem', marginLeft:'.5rem' }}>
                    <IconButton color="primary" onClick={() => { /* Agrega tu lógica de manejo de clic aquí */ }}>
                        <ArrowBackIcon style={{fontSize:'3rem', color:'white'}}/>
                    </IconButton>
                </div>
                <div className="container" style={{marginLeft:'1rem',marginTop:'.2rem'}}>
                    <ResponsiveContainer>
            ...
            <div className="signUp" style={{display:'grid', justifyContent:'center', marginBottom:'1rem', marginTop:'-6rem'}}>
                ...
                <div>
                <div className="signUp" style={{ display: 'grid', justifyContent: 'center', marginBottom: '1rem', marginTop: '' }}>
                    <Button
                    text="Next"
                    width="20rem"
